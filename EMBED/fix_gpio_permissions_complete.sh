#!/bin/bash
# OHT-50 GPIO Permissions Fix Script - COMPLETE
# EMBED Team - Fix SYSFS GPIO access permissions for Orange Pi 5B

echo "=========================================="
echo "OHT-50 GPIO Permissions Fix Script - COMPLETE"
...
# Auto-set permissions for exported GPIO pins
SUBSYSTEM=="gpio", KERNEL=="gpio*", ACTION=="add", RUN+="/bin/chown root:gpio /sys/class/gpio/%k/direction /sys/class/gpio/%k/value /sys/class/gpio/%k/active_low /sys/class/gpio/%k/edge"
SUBSYSTEM=="gpio", KERNEL=="gpio*", ACTION=="add", RUN+="/bin/chmod 660 /sys/class/gpio/%k/direction /sys/class/gpio/%k/value /sys/class/gpio/%k/active_low /sys/class/gpio/%k/edge"
EOF
...
# Unexport existing GPIO pins to clean up
echo "Cleaning up existing GPIO exports..."
