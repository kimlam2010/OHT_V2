...
typedef struct {
    ...
    uint64_t errors_communication;
    uint64_t errors_module_timeout;
    uint64_t errors_retry_exceeded;
...
hal_status_t hal_rs485_handle_communication_error(void);
hal_status_t hal_rs485_retry_communication(const uint8_t *data, size_t length);
hal_status_t hal_rs485_check_module_health(uint32_t module_id);
hal_status_t hal_rs485_reset_communication(void);
