...
#include "04-SERVICES/security_manager.h"
#include <stdint.h>
#include <stdbool.h>
...
typedef struct {
    ...
    security_mgr_resource_t required_resource;
    security_mgr_permission_t required_permission;
    bool authentication_required;
    bool enabled;
} api_mgr_endpoint_t;
